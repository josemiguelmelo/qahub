...
<aside id="menu">
    <div id="navigation">
        ...
        <div class="profile-picture">
            <a href="#profile">
                ...
                <div class="stats-label text-color">
                    <span class="font-extra-bold font-uppercase"> Ricardo Loureiro</span>
                </div>
            </a>
        </div>
        ...
        <ul class="nav" id="side-menu">
            <li >
                <a href="#"> <span class="nav-label">Users</span></a>
            </li>
            <li class="active">
                <a href="#"> <span class="nav-label">Questions</span></a>
            </li>
            <li>
                <a href="#"> <span class="nav-label">Switch normal user</span></a>
            </li>
            <li>
            ...
            <div class="col-md-12">
                <div class="hpanel">
                    <div class="v-timeline vertical-container animate-panel" data-child="vertical-timeline-block" data-delay="1">
                        ...
                        <div class="vertical-timeline-block animated-panel zoomIn" style="-webkit-animation-delay: 0.3s;">
                            <div class="vertical-timeline-icon navy-bg">
                                <i class="fa fa-calendar"></i>
                            </div>
                            <div class="vertical-timeline-content">
                        ...
                        <div class="vertical-timeline-block animated-panel zoomIn" style="-webkit-animation-delay: 0.4s;">
                            <div class="vertical-timeline-icon navy-bg">
                                <i class="fa fa-calendar"></i>
                            </div>
                            <div class="vertical-timeline-content">
                        ...
                        <div class="vertical-timeline-block animated-panel zoomIn" style="-webkit-animation-delay: 0.5s;">
                            <div class="vertical-timeline-icon navy-bg">
                                <i class="fa fa-calendar"></i>
                            </div>
                            <div class="vertical-timeline-content">
                        ...
                        <div class="vertical-timeline-block animated-panel zoomIn" style="-webkit-animation-delay: 0.6s;">
                            <div class="vertical-timeline-icon navy-bg">
                                <i class="fa fa-calendar"></i>
                            </div>
                            <div class="vertical-timeline-content">
